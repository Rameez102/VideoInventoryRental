package com.assignment.videorental.acceptance
...
class FilmRentalAcceptanceSpec extends IntegrationSpec {
    ...
    def 'should rent new release film for one day and return lately'() {
        ...
        then: 'I have to pay 3 EUR for order'
        Long rentalOrderId = 1L
        Long firstRentalId = rentalOrderId

        BigDecimal expectedTotalPrice = BigDecimal.valueOf(3)
        ...
        BigDecimal expectedSurcharge = BigDecimal.valueOf(6)
        ...
        then: 'Rent has ben ended and surcharge increased to 6 EUR'
    ...
    def 'should rent regular and old film and return lately'() {
        ...
        BigDecimal expectedRentalPriceOfSpiderMan = BigDecimal.valueOf(3)
        ...
        BigDecimal expectedRentalPriceOfOutOfAfrica = BigDecimal.valueOf(3)
        ...
        BigDecimal totalPriceOfRental = BigDecimal.valueOf(6)
        ...
        then: 'I get rental details with 6 EUR total price'
        httpSession.getId() >> "1"
        ...
        BigDecimal expectedTotalPrice = BigDecimal.valueOf(6)
        ...
        then: 'I have to pay 6 EUR for order'
        completeRentResultAction
                .andExpect(status().isOk())
                .andExpect(content().json(buildJson(expectedRentalOrder)))
        ...
        BigDecimal expectedSurcharge = BigDecimal.valueOf(4)
        ...
        then: 'Rental of Spider Man has been ended and surcharge increased to 4 EUR'
        ...
        BigDecimal outOfAfricaSurcharge = BigDecimal.valueOf(2)
        ...
        then: 'Rental of Out of Africa has been ended and surcharge increased to 2 EUR'
        timeProvider.today() >> todayPlus(9)
        returnOutOfAfrica
                .andExpect(status().isOk())
        ...
        BigDecimal finalSurcharge = BigDecimal.valueOf(6)
    ...
    def 'should rent regular film and return before end of first days relief'() {
        ...
        BigDecimal spiderManPrice = BigDecimal.valueOf(1)
        ...
        then: 'I have to pay 1 EUR for order'
        completeRentResultAction
                .andExpect(status().isOk())
                .andExpect(content().json(buildJson(expectedRentalOrder)))
